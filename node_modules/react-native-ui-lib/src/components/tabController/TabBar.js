...
const TabBar = props => {
  ...
  const selectedIndicator = itemsWidths && itemsWidths.length > 0 ? <Reanimated.View style={[styles.selectedIndicator, indicatorStyle, _indicatorTransitionStyle]} /> : undefined;
  ...
  const indicatorContainerStyle = useMemo(() => {
    return [styles.tabBar, !_.isUndefined(height) && {
      height
    }, {
      backgroundColor
    }];
...
TabBar.defaultProps = {
  ...
  backgroundColor: DEFAULT_BACKGROUND_COLOR // containerWidth: Constants.screenWidth
